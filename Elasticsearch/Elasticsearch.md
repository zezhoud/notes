...
**示例**：elasticsearch会根据词条和文档的相关度做打分，算法由两种：
...
以百度为例，搜索的结果中，并不是相关度越高排名越靠前，而是谁掏的钱多排名就越靠前。

要想认为控制相关性算分，就需要利用elasticsearch中的function score 查询了。

**语法**：

![image-20220714143434293](assets/image-20220714143434293.png)
...
![image-20220714162808366](assets/image-20220714162808366.png)
...
![image-20210721224033789](assets/image-20210721224033789-7791095.png)

请求参数如下：

![image-20210721224112708](assets/image-20210721224112708-7791095.png)
...
![image-20210721191544750](/Users/scott/Documents/Learning/Java/Spring Cloud/分布式搜索引擎/assets/image-20210721191544750.png)

对应的JavaAPI如下：

![image-20210722102850818](/Users/scott/Documents/Learning/Java/Spring Cloud/分布式搜索引擎/assets/image-20210722102850818.png)
...
需要对桶内的酒店做运算，获取每个品牌的用户评分的min、max、avg等值。
...
![image-20220717180512803](assets/image-20220717180512803.png)
...
将hotel-admin项目作为酒店管理的微服务。当酒店数据发生增、删、改时，要求对elasticsearch中数据也要完成相同操作。
...
![image-20210602221115763](/Users/scott/Documents/Learning/Java/Spring Cloud/分布式搜索引擎/image-20210602221115763.png)
